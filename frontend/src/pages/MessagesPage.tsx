      ...
      <div className="mb-6">
        <div className="flex space-x-8 border-b border-gray-300">
          <button
            ...
            className="border-b-2 border-transparent px-2 pb-3 text-sm font-medium text-gray-600 transition-colors hover:border-gray-300 hover:text-gray-800"
          >
            Quản lý bài đăng
          </button>
          <button className="border-b-2 border-blue-600 px-2 pb-3 text-sm font-semibold text-blue-600">
            Tin nhắn
          </button>
        </div>
      </div>
